...
export default async function NewAnimalPage() {
  ...
  return (
    <div className="max-w-lg space-y-6">
      ...
      <form action={handleCreate} className="space-y-4 rounded-xl border border-zinc-800 bg-zinc-900/50 p-6">
        <div className="space-y-1">
          <label className="text-sm text-zinc-400">Brinco (número)</label>
          <input
            name="tagNumber"
            placeholder="Ex: 123 (deixe em branco se sem brinco)"
        ...
        <div className="flex gap-3 pt-2">
          ...
          <Link
            href="/animals"
            className="flex-1 text-center bg-zinc-700 hover:bg-zinc-600 text-white py-2 rounded-lg font-medium transition-colors"
          >
            Cancelar
          </Link>
        </div>
